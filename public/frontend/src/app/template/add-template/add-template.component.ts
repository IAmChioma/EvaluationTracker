...
export class AddTemplateComponent implements OnInit {
  ...
  questions: Question[] = []; 
  question = "";
  @Output() addEventEmmiter : EventEmitter<Template> = new EventEmitter<Template>();
  constructor(private _templateService:TemplateDataService, private _router:Router, private _location:Location) { }
  ...
  addTemplate(form:NgForm){
    ...
    this._templateService.createTemplate(this.template).subscribe({
      next: (newTemplate)=>{ 
